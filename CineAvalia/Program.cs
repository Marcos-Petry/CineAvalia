...
var connectionString = builder.Configuration.GetConnectionString("ConnectionPostgres"); // busca a string de conexão do banco, que  foi definida no arq appsettings.development
